...
async function fetchData() {
  const res = await fetch('https://98ec1f7320b02e63.mokky.dev/operation_1943')
...
function goToDetail(id) {
  router.push({ name: 'card-detail-1943', params: { id } })
}
</script>
<!-- <div class="max-w-214 hidden"></div>
  <div class="max-w-200 hidden"></div>
  <div class="max-w-115 hidden"></div>
  <div class="max-w-344 hidden"></div>
    <div class="max-w-336 hidden"></div> -->

<template>
  <div class="block max-w-1640 mx-auto text-center mt-150">
    <h2 class="font-ptsans text-40" id="operation1943">Операции 1943 года</h2>
    <div class="mt-30">
